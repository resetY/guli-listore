 ...
 */
@RestController
@RequestMapping("gulimember/smscouponspurelation")
public class SmsCouponSpuRelationController {
     ...
     */
    @RequestMapping("/list")
 //   @RequiresPermissions("gulimember:smscouponspurelation:list")
    ...
    //@RequiresPermissions("gulimember:smscouponspurelation:info")
     ...
     */
    @RequestMapping("/save")
   // @RequiresPermissions("gulimember:smscouponspurelation:save")
    ...
    //@RequiresPermissions("gulimember:smscouponspurelation:update")
   ...
   // @RequiresPermissions("gulimember:smscouponspurelation:delete")
