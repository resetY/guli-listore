...
import com.yuan.guli.gulimember.service.SmsCouponService;
 ...
 */
@RestController
@RequestMapping("gulimember/smscoupon")
public class SmsCouponController {
     ...
     */
    @RequestMapping("/list")
 //   @RequiresPermissions("gulimember:smscoupon:list")
    ...
    //@RequiresPermissions("gulimember:smscoupon:info")
     ...
     */
    @RequestMapping("/save")
   // @RequiresPermissions("gulimember:smscoupon:save")
    ...
    //@RequiresPermissions("gulimember:smscoupon:update")
   ...
   // @RequiresPermissions("gulimember:smscoupon:delete")
