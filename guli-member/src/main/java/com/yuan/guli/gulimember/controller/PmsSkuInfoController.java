...
import com.yuan.guli.gulimember.service.PmsSkuInfoService;
 ...
 */
@RestController
@RequestMapping("gulimember/pmsskuinfo")
public class PmsSkuInfoController {
     ...
     */
    @RequestMapping("/list")
 //   @RequiresPermissions("gulimember:pmsskuinfo:list")
    ...
    //@RequiresPermissions("gulimember:pmsskuinfo:info")
     ...
     */
    @RequestMapping("/save")
   // @RequiresPermissions("gulimember:pmsskuinfo:save")
    ...
    //@RequiresPermissions("gulimember:pmsskuinfo:update")
   ...
   // @RequiresPermissions("gulimember:pmsskuinfo:delete")
