...
import com.yuan.guli.gulimember.service.PmsCommentReplayService;
 ...
 */
@RestController
@RequestMapping("gulimember/pmscommentreplay")
public class PmsCommentReplayController {
     ...
     */
    @RequestMapping("/list")
 //   @RequiresPermissions("gulimember:pmscommentreplay:list")
    ...
    //@RequiresPermissions("gulimember:pmscommentreplay:info")
     ...
     */
    @RequestMapping("/save")
   // @RequiresPermissions("gulimember:pmscommentreplay:save")
    ...
    //@RequiresPermissions("gulimember:pmscommentreplay:update")
   ...
   // @RequiresPermissions("gulimember:pmscommentreplay:delete")
