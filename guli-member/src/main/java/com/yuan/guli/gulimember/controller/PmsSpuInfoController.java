...
import com.yuan.guli.gulimember.service.PmsSpuInfoService;
 ...
 */
@RestController
@RequestMapping("gulimember/pmsspuinfo")
public class PmsSpuInfoController {
     ...
     */
    @RequestMapping("/list")
 //   @RequiresPermissions("gulimember:pmsspuinfo:list")
    ...
    //@RequiresPermissions("gulimember:pmsspuinfo:info")
     ...
     */
    @RequestMapping("/save")
   // @RequiresPermissions("gulimember:pmsspuinfo:save")
    ...
    //@RequiresPermissions("gulimember:pmsspuinfo:update")
   ...
   // @RequiresPermissions("gulimember:pmsspuinfo:delete")
