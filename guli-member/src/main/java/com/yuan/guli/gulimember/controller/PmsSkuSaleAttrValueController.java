...
import com.yuan.guli.gulimember.service.PmsSkuSaleAttrValueService;
 ...
 */
@RestController
@RequestMapping("gulimember/pmsskusaleattrvalue")
public class PmsSkuSaleAttrValueController {
     ...
     */
    @RequestMapping("/list")
 //   @RequiresPermissions("gulimember:pmsskusaleattrvalue:list")
    ...
    //@RequiresPermissions("gulimember:pmsskusaleattrvalue:info")
     ...
     */
    @RequestMapping("/save")
   // @RequiresPermissions("gulimember:pmsskusaleattrvalue:save")
    ...
    //@RequiresPermissions("gulimember:pmsskusaleattrvalue:update")
   ...
   // @RequiresPermissions("gulimember:pmsskusaleattrvalue:delete")
